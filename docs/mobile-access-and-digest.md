...
| Variable | Purpose |
|----------|---------|
| `FINANCE_HUB_API_KEY` | Optional. When set, all `/api/*` routes require Bearer auth (see [security.md](../security.md)). Required before binding to LAN or exposing via Tailscale/VPN. |
