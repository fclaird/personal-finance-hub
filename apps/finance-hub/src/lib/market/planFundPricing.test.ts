...
import {
  buildFundStatementBasisFromNav,
  markToMarketFund,
...
test("buildFundStatementBasisFromNav fails closed without a real Yahoo NAV", () => {
  assert.equal(buildFundStatementBasisFromNav(194_528, "2026-05-01", null), null);
  assert.equal(buildFundStatementBasisFromNav(194_528, "2026-05-01", 0), null);
  assert.equal(buildFundStatementBasisFromNav(194_528, "2026-05-01", Number.NaN), null);
  assert.deepEqual(buildFundStatementBasisFromNav(194_528, "2026-05-01", 354), {
